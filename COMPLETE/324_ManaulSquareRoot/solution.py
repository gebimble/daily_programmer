...
def slicer(number, operating_number, a, b):
    ...
    if a:
        if b:
            operating_number = str(int(operating_number)
                                   - (((20 * a) + b) * b)) + number[:2]
        else:
            operating_number = str(int(operating_number)
                                   - ((a ** 2))) + number[:2]
...
def manual_sqrt(precision, number):
    ...
    operating_no, massaged_no, decimal_flag = slicer(massaged_no,
                                                     operating_no,
                                                     a, b)

    if not a:
        for a in range(9, -1, -1):
            if (a ** 2) > float(operating_no):
                pass
            else:
                break
    ...
    while True:
        ...
        for b in range(9, -1, -1):
            ...
            if (((20 * a) + b) * b) > float(operating_no):
                pass
            else:
                break
